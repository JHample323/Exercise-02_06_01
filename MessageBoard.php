...
<body>
        ...
        filesize("messages.txt") == 0) {
            ...
            foreach ($keyMessageArray as $message) {
                ...
                echo "<td width=\"10%\" style=\"text-align:center\">" . "<a href='MessageBoard.php?" . "action=Delete%20Message&" . "message=" . 
                ($index - 1) . "'>" . 
        ...
        <p>
            ...
            <a href="MessageBoard.php?action=Deletet%20First">Delete First Message</a><br>
            <a href="MessageBoard.php?action=Sort%20Ascending">Sort Subjects A-Z</a><br>
            <a href="MessageBoard.php?action=Sort%20Decending">Sort Subjects Z-A</a><br>
